...
class BatchWriter(object):
    ...
    def parse_file_list(self, infile):
        print infile
        # http://stackoverflow.com/questions/28254992/python-doesnt-read-in-the-correct-number-of-columns
        lines = np.loadtxt(infile, delimiter=',', skiprows=1, dtype={'names': ('fname', 'l_id'),
                                                                     'formats': (object, 'i4')}, comments=None)
...
if __name__ == "__main__":
    ...
    if args.set_type == 'i1k':
        ...
        bw = BatchWriter(out_dir=args.data_dir, image_dir=args.image_dir,
                         ...
                         file_pattern=args.file_pattern, validation_pct=args.val_pct)
